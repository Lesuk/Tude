class ApplicationController < ActionController::Base
  ...
  helper_method :search_objects_type

  include FlashHelper

  def search_objects_type
    if params[:controller] == 'articles' || params[:action] == 'articles'
      'articles'
    elsif params[:controller] == 'questions' || params[:action] == 'questions'
      'questions'
    else
      'courses'
    end
